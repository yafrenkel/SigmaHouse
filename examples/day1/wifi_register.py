# -*- coding: utf-8 -*-
"""Stand-alone module to demo WiFi network connectivity and API call for registration."""
...
if not wifi_connect_success:
    ...
    # Prepare data for registration with IoT Hub
    data = {
        "unique_id": wifi_mac_address,
    ...
    print(secret_config["api_endpoint"])

    # Issue HTTP POST request to IoT Hub API
    response = urequests.post(
        secret_config["api_endpoint"], data=json_data, headers=headers
    )

    # Print IoT Hub response
